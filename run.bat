...
echo.
echo ============================================
echo   Weather AI Agent - Starting Everything
echo ============================================
...
start /B python web\dashboard.py >nul 2>&1
...
python -c "import sys; sys.stdout.reconfigure(encoding='utf-8'); exec(open('main.py', encoding='utf-8').read())" --loop --hermes-run
